...
export default function BrandMediaBlock() {
  const brandMedia = [
    ...
    { title: 'Digital Asset Pack', desc: 'Photo + video deliverables designed for ads, Instagram/TikTok, LinkedIn, and websites.', img: '/images/AP.jpg' },
    { title: 'Campaign Coverage', desc: 'Editorial documentation of launches, pop-ups, press previews, and fashion shows.', img: '/images/lagos01/2.jpg' },
  ]
